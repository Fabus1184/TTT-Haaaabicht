...
if CLIENT then
  ...
  SWEP.EquipMenuData = {
    type = "item_weapon",
    desc = "Zugeschlagen - Lösung bitte?  HAAAAAAAAAABBBBBBBIIIIIIIIIICCCCCCCCHHHHHHHHHTTTTTTTTTTTT"
  };

  SWEP.Icon = "VGUI/ttt/icon_hominghabicht.png"
